...
impl Workload {
    ...
    /// Returns the number of shards accessed by commands generated by this workload.
    pub fn shards_per_command(&self) -> usize {
        self.shards_per_command
    }

    /// Returns the number of keys in each shard accessed by commands generated by this workload.
