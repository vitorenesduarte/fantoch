    ...
    V: Clone,
{
    ...
    /// Generates the first ballot (panics if not the first).
    pub fn first_ballot(&mut self) -> Ballot {
        self.proposer.first_ballot(&self.acceptor)
    }
    ...
    V: Clone,
{
    ...
    /// Generates the first ballot (panics if not the first).
    fn first_ballot(&mut self, acceptor: &Acceptor<V>) -> Ballot {
