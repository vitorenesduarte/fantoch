    ...
    V: Clone + Default,
{
    ...
    fn reset_state(&mut self) -> (Promises<V>, Proposal) {
        // reset promises
    ...
    fn handle_accepted(&mut self, from: ProcessId, b: Ballot) -> Option<SynodMessage<V>> {
        ...
        if self.ballot == b {
            ...
            if self.accepts.len() == self.f + 1 {
                ...
                // extract proposal
                let proposal = proposal.expect("there should have been proposal before a value can be chosen");
