...
mod tests {
    ...
    fn search() {
        ...
        for (config, stats) in css {
            ...
            let n = 5;
            if config.len() == n {
                let expected = "af1=min=202    max=347    std=54     avg=271    p95=339    p99=347    p99.9=347    p99.99=347    ff1=min=202    max=583    std=99     avg=419    p95=525    p99=583    p99.9=583    p99.99=583    af2=min=265    max=391    std=42     avg=314    p95=358    p99=391    p99.9=391    p99.99=391    ff2=min=211    max=592    std=99     avg=428    p95=534    p99=592    p99.9=592    p99.99=592    e=min=202    max=347    std=54     avg=271    p95=339    p99=347    p99.9=347    p99.99=347    af1C=min=202    max=280    std=36     avg=234    p95=280    p99=280    p99.9=280    p99.99=280    ff1C=min=202    max=525    std=128    avg=410    p95=525    p99=525    p99.9=525    p99.99=525    af2C=min=265    max=302    std=14     avg=280    p95=302    p99=302    p99.9=302    p99.99=302    ff2C=min=211    max=534    std=128    avg=419    p95=534    p99=534    p99.9=534    p99.99=534    eC=min=202    max=280    std=36     avg=234    p95=280    p99=280    p99.9=280    p99.99=280    ";
